...
const ConfiguracoesGestorPage: React.FC = () => {
      ...
      .then((res) => {
        ...
        if (userId) {
          axios
            ...
            .then((gestorRes) => {
              setNome(gestorRes.data.nome || "");
              setLogin(gestorRes.data.login || "");
              setEmail(gestorRes.data.email || "");
            })
            .catch(() => {
              setMensagem("Não foi possível carregar os dados do gestor.");
            });
        } else {
